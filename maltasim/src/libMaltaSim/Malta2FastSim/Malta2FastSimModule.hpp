/**
 * @file
 * @brief Definition of [Malta2FastSim] module
 *
...
namespace allpix {
     ...
     * for a quicker start.
     */
    class Malta2FastSimModule : public SequentialModule {
    public:
        /**
         ...
         */
        Malta2FastSimModule(Configuration& config, Messenger* messenger, std::shared_ptr<Detector> detector);
